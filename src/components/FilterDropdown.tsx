...
export default function FilterDropdown({ filter, setFilter }: Props) {
  return (
    <div>
      <p className="text-sm font-normal mb-2">Filter By Age</p>
      <Menu as="div" className="relative inline-block text-left w-2/5">
        <div>
